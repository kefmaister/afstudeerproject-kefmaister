<x-guest-layout wide="true">
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <x-text-input id="password" name="password" type="password" required placeholder="Voer je wachtwoord in"
                class="w-full mt-1" />
        ...
        <div class="flex flex-col md:flex-row gap-4 items-start">
            ...
            <div class="w-full md:w-1/2 space-y-4">
                ...
                <div>
                    ...
                    <x-text-input id="company_vat" name="company_vat" type="text" placeholder="BTW-nummer van het bedrijf"
                        :value="old('company_vat')" class="w-full mt-1" />
                    <x-input-error :messages="$errors->get('company_vat')" class="mt-2" />
                </div>
                <div>
                    <x-input-label for="employee_count" :value="__('Aantal werknemers')" />
