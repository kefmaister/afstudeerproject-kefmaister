<x-app>
    ...
    <form method="POST" action="{{ route('company.profile.update') }}" enctype="multipart/form-data"
        ...
        {{-- Company Name and Logo in One Row --}}
        <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
            ...
            <div class="flex justify-center md:justify-end mt-6 md:mt-0">
                ...
                @else
                    <div
                        class="h-24 w-24 bg-gray-100 border flex items-center justify-center text-sm text-gray-500 rounded">
                        Geen logo
                    </div>
                @endif
            </div>
        ...
        <div>
            ...
            <input type="number" name="max_students" id="max_students"
                value="{{ old('max_students', $company->max_students) }}" class="w-full border-gray-300 rounded p-2">
        </div>
